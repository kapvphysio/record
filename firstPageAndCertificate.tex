...
\usepackage[a4paper, left=1.5in,right=.75in,top=2cm,bottom=1.5cm]{geometry}
...
\begin{table}[H]
 ...
 \resizebox{\textwidth}{!}{%
	 \begin{tabular}{p{.55\textwidth}p{.45\textwidth}}
		 \textbf{Asst.Professor}, &\textbf{Professor \& Head,}\\ 
		 \textbf{Department of Physiology} &\textbf{Department of Physiology}\\ 
		 \textbf{KAPV Govt Medical College} &\textbf{KAPV Govt Medical College}
\end{tabular}
 }
 \end{table}
