...
\item{Volume}
\item{Character}
\item{Condition of the vessel wall}
\item{Radiofemoral delay}
\item{Examination of other peripheral pulses.}
\end{enumerate}

Radial pulse is examined for Rate, Rhythm and Volume
\par
Hold the subjects right arm in the semi prone position with slight flexion at the wrist. The radial pulse is palpated using the right index, middle and ring fingers by gently compressing the artery against the radial styloid process. Count for one full minute.
											    \end{document}
