...
\usepackage{tabularx}
\usepackage[a4paper, left=1.45in,right=.7in,top=2cm,bottom=1.5cm,footskip=.15cm]{geometry}
\usepackage{fancyhdr}
\pagestyle{fancy}
...
\newcommand\@putfig{%
	%\newgeometry{left=.7in,right=1.45in}
	\@addfig\addfig{\relax}
	%\restoregeometry
	}
\newcommand\blankpage{%
...
%the following command in used to include the chapter title in header when the chapter command in used with chapter*
\markboth{\uppercase{Compound Microscope}}{}
...
\markboth{\uppercase{Hemocytometer}}{}
			...
			\end{tabular}
				...
				\addfig{%
					\begin{figure}[h]
						\centering
							\includegraphics[scale=.45]{./grid.jpg}
...
\markboth{\uppercase{Estimation Of Total RBC Count}}{}
					...
					\vspace{-4mm}
					\begin{tabbing}
						Mercuric perchloride \= - \= 100 ml \= - \= Acts  as preservative, antifungal and antibacterial\kill\\

						Sodium chloride \> - \> 0.5 $g$	\>- \>Maintains isotonicity\\

						Mercuric perchloride \>- \>0.25 $g$ \>- \>Acts  as preservative, antifungal and antibacterial\\
...
\markboth{\uppercase{Estimation Of Total WBC Count}}{}
...
\markboth{\uppercase{Absolute Eosinophil Count}}{}
...
Number of cells in 1 $mm^3$ of undiluted blood \= = \= n$\times$$\frac{10}{9}$$\times$10 \= = \= \kill\\
					...
					\addfig{%
						\begin{figure}[h]
							...
							\caption*{\textbf{Zig - Zag movement of the slide for counting}}
							\label{smear3}
						\end{figure}
						}
					\chapter*{\centering Differential Count}
\addcontentsline{toc}{chapter}{Differential Count}
\markboth{\uppercase{Differential Count}}{}
					...
					\section*{Procedure}
						...
						\addfig{%
							...
							\\
							\begin{center}
								\begin{tabularx}{\textwidth}{|*{5}{p{.2\textwidth}|X|}}
									%{|c|c|X|X|c|}
									\hline
									\textbf{Cell type}&
									\textbf{Size}&
...
\markboth{\uppercase{Hemoglobin Estimation}}{}
							\begin{tabular}{p{5in} p{1in}}
								\textbf{Exp No:}  & \textbf{Date:}\\
							\end{tabular}
							...
							\section*{Aim}
								...
								\addfig{%
									\begin{figure}[h]
										\centering
										\includegraphics[scale=.8]{./bloodGrouping.jpg}
										\label{bloodGrouping}
...
\markboth{\uppercase{Blood Grouping \& Typing}}{}
								\begin{tabular}{p{5in} p{1in}}
									\textbf{Exp No:}  & \textbf{Date:}\\
								\end{tabular}
...
\markboth{\uppercase{Estimation Of Bleeding Time}}{}
									\begin{tabular}{p{5in} p{1in}}
										\textbf{Exp No:}  & \textbf{Date:}\\
									\end{tabular}
...
\markboth{\uppercase{Estimation Of Clotting Time}}{}
										\begin{tabular}{p{5in} p{1in}}
											\textbf{Exp No:}  & \textbf{Date:}\\
										\end{tabular}
										\section*{Aim}
...
\markboth{\uppercase{Estimation Of Erythrocyte Sedimentation Rate}}{}
											\begin{tabular}{p{5in} p{1in}}
												\textbf{Exp No:}  & \textbf{Date:}\\
											\end{tabular}
											\section*{Aim}
...
\markboth{\uppercase{Packed Cell Volume}}{}
												\begin{tabular}{p{5in} p{1in}}
													\textbf{Exp No:}  & \textbf{Date:}\\
												\end{tabular}
...
\markboth{\uppercase{Osmotic Fragility}}{}
													\begin{tabular}{p{5in} p{1in}}
														\textbf{Exp No:}  & \textbf{Date:}\\
													\end{tabular}
													...
													\section*{Aim}
														...
														\end{enumerate}
														%-----------------------t{{{
															{\tiny {\csvautotabular{./osmoticFragility.csv}}}
%-----------------------t											
														...
														\addfig{%
															\begin{figure}[h]
																\centering
																\includegraphics[scale=.34]{./specificGravity.jpg}
...
\markboth{\uppercase{Specific Gravity}}{}
...
\markboth{\uppercase{General Examination}}{}
															...
															\begin{itemize}
			\itemsep0em													\item{\textbf{Areas to look for cyanosis:}}
\begin{itemize}
		\itemsep0em
\item{Lips}
\item{Tongue}
...
\begin{table}[H]
	\centering
	\scriptsize{%
	\begin{tabular}{|p{.5in}|p{.75in}|p{2in}|p{2in}|} 
		\hline
...
%--------------Examination of Respiratory System--{{{
															\addfig{%
																...
																\begin{figure}[h]
																	...
																	\caption*{\textbf{Abnormal Chest Shapes}}
...
\markboth{\uppercase{Examination Of Respiratory System}}{}
...
\markboth{\uppercase{Respiratory Efficiency Test}}{}
...
\markboth{\uppercase{Examination of the Arterial Pulse}}{}
															\begin{tabular}{p{5in} p{1in}}
																\textbf{Exp No:}  & \textbf{Date:}\\
															\end{tabular}
\section*{Definition:}
...
\addfig{%
	...
	\begin{figure}[H]
		...
		\caption*{\textbf{Examination Of Jugular Venous Pulse \& Measurement of Jugular Venous Pressure}}
		\label{jvp}
	\end{figure}
	}
...
\markboth{\uppercase{Examination Of Cardiovascular System}}{}
															\begin{tabular}{p{5in} p{1in}}
																\textbf{Exp No:}  & \textbf{Date:}\\
															\end{tabular}
															\par
...
\addfig{%
	...
	\centering
		...
		\caption*{\textbf{Auscultating Areas}}
...
\par
\noindent 1$^{st}$ heart sound (S1) is produced by closure of AV valves.\newline
2$^{nd}$ heart sound (S2) is produced by closure of semilunar valves.\newline
3$^{rd}$ heart sound (S3) is due to vibrations set up by rapid ventricular filling.\newline
4$^{th}$ heart sound (S4) is due to atrial systole.\newline
\par
...
\item{What is pericardial effusion?}
	...
	\subcaption{Aneroid Sphygmomanometer}
																...
																\end{subfigure}
																	\caption*{\textbf{Types Of Sphygmomanometer}}
...
\markboth{\uppercase{Recording of Blood Pressure}}{}
															\begin{tabular}{p{5in} p{1in}}
																\textbf{Exp No:}  & \textbf{Date:}\\
															\end{tabular}
															\section*{Definition:}
...
\markboth{\uppercase{Effects of Posture and Exercise on	Blood Pressure}}{}
															\begin{tabular}{p{5in} p{1in}}
																\textbf{Exp No:}  & \textbf{Date:}\\
															\end{tabular}
\section*{Aim:}
...
\markboth{\uppercase{Examination Of Sensory System}}{}
															\begin{tabular}{p{5in} p{1in}}
																\textbf{Exp No:}  & \textbf{Date:}\\
															\end{tabular}
...
\markboth{\uppercase{Examination Of Motor System}}{}
															\begin{tabular}{p{5in} p{1in}}
																\textbf{Exp No:}  & \textbf{Date:}\\
															\end{tabular}
															\section*{Introduction}
...
\addfig{
	\begin{figure}[H]
		\begin{subfigure}[t]{.25\textwidth}
			\includegraphics[width=4cm,height=5cm]{./clinicalPhysioPic/motorSystem/abductorPollicisBrevis.jpg}
			\subcaption{Testing abductor Pollicis brevis}
		\end{subfigure}
		\hspace{\fill}
		\begin{subfigure}[t]{.25\textwidth}
			\includegraphics[width=4cm,height=5cm]{./clinicalPhysioPic/motorSystem/opponensPollicis.jpg}
			\subcaption{Testing opponens pollicis}
		\end{subfigure}
		\hspace{\fill}
		\begin{subfigure}[t]{.25\textwidth}
			\includegraphics[width=4cm,height=5cm]{./clinicalPhysioPic/motorSystem/interossesi.jpg}
...
\addfig{
	\begin{figure}[H]
		...
		\end{subfigure}
		\hspace{\fill}
		\caption*{\textbf{Superficial Reflexes}}
	\end{figure}
}
...
\markboth{\uppercase{Cerebellar Function Tests}}{}
															\begin{tabular}{p{5in} p{1in}}
																\textbf{Exp No:}  & \textbf{Date:}\\
															\end{tabular}
...
\markboth{\uppercase{Examination Of Cranial Nerves (1-6)}}{}
															\begin{tabular}{p{5in} p{1in}}
																\textbf{Exp No:}  & \textbf{Date:}\\
															\end{tabular}
...
\item{Light Perception test}
		...
		\subsubsection*{Test for near vision : (Jaegar’s chart)}
			...
			\addfig{
				\begin{figure}[h]
					\centering
					\includegraphics[width=12cm,height=15cm]{./clinicalPhysioPic/cranialNerves1_6/extraocularMuscles.jpg}
					\caption*{\textbf{Extraocular Muscles}}
				\end{figure}
				}
			...
			As Optic nerve is a component of pupillary reflexes, light reflex and accommodation reflex are tested.
...
\markboth{\uppercase{Examination Of Cranial Nerves (7-12)}}{}
															\begin{tabular}{p{5in} p{1in}}
																\textbf{Exp No:}  & \textbf{Date:}\\
															\end{tabular}
...
\addfig{
	...
	\begin{figure}[h]
		...
		\end{subfigure}
		\hspace{\fill}
		\caption*{\textbf{Examination Of Soft Palate and Palatine Reflex}}
	\end{figure}
}
...
\addfig{
	...
	\begin{figure}[h]
		...
		\end{subfigure}
		\hspace{\fill}
		\caption*{\textbf{Examination Of XI cranial nerve}}
	\end{figure}
}
