...
\section*{3, 4 \& 6 CRANIAL NERVES –OCCULOMOTOR, TROCHLEAR \& ABDUCENT NERVES (Purely motor)}
...
\end{itemize}
\section*{5$^{th}$ CRANIAL NERVE: TRIGEMINAL NERVE (MIXED NERVE)}
...
%-----------------------}}}
														...
														\chapter*{\centering Examination Of Cranial Nerves (7-12)}
															\begin{tabular}{p{5in} p{1in}}
																\textbf{Exp No:}  & \textbf{Date:}\\
															\end{tabular}
\section*{7$^{th}$ CRANIAL NERVE – FACIAL NERVE (Mixed nerve)}
\addfig{
	\centering
	\begin{figure}
...
\subsection*{EXAMINATION OF FACIAL NERVE}
\subsubsection*{Motor component:}
...
\end{itemize}
\subsubsection*{Sensory component:}
...
\item{Ask for any history suggestive of hyperacusis (stapedius)}
		...
		\section*{8th CRANIAL NERVE- VESTIBULO-COCHLEAR NERVE (Purely sensory)}
...
\section*{9$^{th}$ CRANIAL NERVE – GLOSSOPHARYNGEAL NERVE (Mixed nerve)}
\addfig{
	\centering
	\begin{figure}
		\begin{subfigure}[t]{.48\textwidth}
...
\section*{10$^{th}$ CRANIAL NERVE – VAGUS NERVE (Mixed nerve)}
...
\end{itemize}
\section*{11th CRANIAL NERVE – SPINAL ACCESSORY NERVE (Purely motor) }
\addfig{
	\centering
	\begin{figure}
		\begin{subfigure}[t]{.48\textwidth}
...
\section*{12th CRANIAL NERVE – HYPOGLOSSAL NERVE (Purely motor)}
