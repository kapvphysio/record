...
\usepackage{tabularx}
\usepackage[a4paper, left=1.45in,right=.7in,top=2cm,bottom=1.5cm,footskip=.5cm]{geometry}
\usepackage{fancyhdr}
...
\addcontentsline{toc}{chapter}{Estimation Of Total RBC Count}
					...
					\section*{Calculation}
					\begin{tabbing}
					Number of RBCs in 5 medium sized RBC squares \= = \= $\frac{1}{25}$ $\times$ $\frac{1}{15}$ \= = \= hellohow \kill\\
