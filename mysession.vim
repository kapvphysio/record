...
xnoremap <silent> <M-F5> :call UltiSnips#SaveLastVisualSelection()gvs
snoremap <silent> <M-F5> :call UltiSnips#ExpandSnippet()
...
iabbr wehn when
iabbr adn and
iabbr @@ gnanasenthil654321@gmail.com
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set background=dark
...
silent only
silent tabonly
cd /media/physiology/Local\ Diskf/Academics/2017Record/record
...
let s:l = 1049 - ((1012 * winheight(0) + 16) / 32)
